            ...
            <div className="drawer drawer-end fixed top-0">
                ...
                <div className="drawer-content flex flex-col">
                    ...
                    <div className="w-full navbar  bg-base-300 px-12">
                        <div className="flex-1 px-2 mx-2 font-bold text-2xl">
                            <img style={{ 'width': '20px', 'color': 'red' }} src={b} alt="" className='mr-4' /> Best Tools co.</div>
                        ...
                        <div className="flex-none hidden lg:block  ">
                            <ul className="menu  menu-horizontal gap-x-2  ">
                                <li><NavLink className='rounded-lg  my-2 ' to='/'>Home</NavLink></li>

                                <li><NavLink className='rounded-lg  my-2' to='/blogs'>Blogs</NavLink></li>
                                <li><NavLink className='rounded-lg  my-2' to='/myportfolio'>My Portfolio</NavLink></li>
                ...
                <div className="drawer-side   " >
                    ...
                    <ul className="menu p-2 overflow-y-auto w-80 bg-base-100">
                        ...
                        {user ? <li><button className='bg-primary rounded-lg  my-2' onClick={logout}>Sign Out</button></li> : <li><NavLink className='rounded-lg  my-2' to='/login'>Log In</NavLink></li>}
